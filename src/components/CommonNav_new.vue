<template>
  <div class="CommonNav" style="height: 0">
    <div class="menu mobileMenu" style="width: 1200px;">
    ...
    <div class="menuPC">
          <Row>
            <i-col :xs="24" :sm="24" :md="24">
              ...
              <Menu active-key="1" ref="menu" theme="primary" :active-name="active" @on-select="routerTo" style="border: 1px solid green; border-radius: 0.1rem;">
