...
export default {
  ...
  mounted: function(){
    ...
    //this.getSimilar();
    this.getDisclaimer();
    this.getApiData( this.global.Domain.api1 +'/document/html?unique_code=' + this.$route.params.unique_code + '&table_flag=' );
  },
  methods: {
    'getPolicyDetail':function() {
      ...
      const prommise_getPolicyDetail = _this.global.$post({
        '_this': _this,
        'url': _this.global.API.Policy.GetPolicyLawsInfoByID,
        'data': {
