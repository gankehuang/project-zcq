<template>
  <div class="CountryList">
    <router-link class="" :to="'/countrymaplist'">
      <Poptip trigger="hover" content="Click to switch to the world map page for details of each country" placement="right" >
          <i-button id="chagelist">World Map</i-button>
      </Poptip> 
    </router-link>
    ...
    <!-- <Card class="AreaList" v-bind:class="{active: arealist_active}">
      ...
      <div class="list">
        <div class="bold navtext" key="0" :class="{nav:curr==0}"><a v-on:click="getCountry(0, 'All', {}, 10)">All</a></div>
    ...
    <Card class="CountryInfo" :bordered="false">
     <!--  <p slot="title" class="AreaName">{{areaname_selected}}</p>
     <div class="countrylist">
       <router-link class="item" v-for="item in countrylist" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.ID}}">
         <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img>
         <div class="info">
           <img class="countryImage" :src="global.normalResourceUrl(item.countryFlag||item.NationalFlag)" />
           <span class="imagename">{{item.countryName || item.NameOfficialEN}}</span>
         </div>
       </router-link>
     </div>
    ...
    <Card class="CountryListName" style="margin-top: 0px;">
        <p slot="title" class="AreaName">Asia</p>
        <div class="countrylist" style="border-bottom: 1px dashed #DDDEE1">
          <p slot="title" style="text-align: left; font-weight: bold;">Southeast Asia</p>
          <router-link class="item" v-for="item in DNY" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
        <div class="countrylist" style="border-bottom: 1px dashed #DDDEE1">
          <p slot="title" style="text-align: left; font-weight: bold;">South Asia</p>
          <router-link class="item" v-for="item in NY" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
        <div class="countrylist" style="border-bottom: 1px dashed #DDDEE1">
          <p slot="title" style="text-align: left; font-weight: bold;">Western Asia</p>
          <router-link class="item" v-for="item in XY" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
        <div class="countrylist" style="border-bottom: 1px dashed #DDDEE1">
          <p slot="title" style="text-align: left; font-weight: bold;">Central Asia</p>
          <router-link class="item" v-for="item in ZY" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
        <div class="countrylist" style="border-bottom: 1px dashed #DDDEE1">
          <p slot="title" style="text-align: left; font-weight: bold;">East Asia</p>
          <router-link class="item" v-for="item in DY" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
    ...
    <Card class="CountryListName" style="margin-top: 5px;" v-if="FZ[0]">
        <p slot="title" class="AreaName">Africa </p>
        <div class="countrylist">
          <router-link class="item" v-for="item in FZ" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
    ...
    <Card class="CountryListName" style="margin-top: 5px;" v-if="OZ[0]">
        <p slot="title" class="AreaName">Europe</p>
        <div class="countrylist">
          <router-link class="item" v-for="item in OZ" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
   ...
   <Card class="CountryListName" style="margin-top: 5px;" v-if="BMZ[0]">
        <p slot="title" class="AreaName">North America</p>
        <div class="countrylist">
          <router-link class="item" v-for="item in BMZ" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
    ...
    <Card class="CountryListName" style="margin-top: 5px;" v-if="NMZ[0]">
        <p slot="title" class="AreaName">South America</p>
        <div class="countrylist">
          <router-link class="item" v-for="item in NMZ" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
    ...
    <Card class="CountryListName" style="margin-top: 5px;" v-if="DYZ[0]">
        <p slot="title" class="AreaName">Oceania</p>
        <div class="countrylist">
          <router-link class="item" v-for="item in DYZ" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
    ...
    <Card class="CountryListName" style="margin-top: 5px;" v-if="NJZ[0]">
        <p slot="title" class="AreaName">Antarctica</p>
        <div class="countrylist">
          <router-link class="item" v-for="item in NJZ" :key="item.countryID" :to="{name:'countrydetailen', params:{countryid:item.CountryID}}">
            <!-- <img :src="global.normalResourceUrl(item.countryFlag)">{{item.countryName}}</img> -->
            <div class="info"><span class="imagename">{{item.ENLong}}</span></div>
          </router-link>
        </div>
...
export default {
  ...
  methods: {
    ...
    'getMoreInfo': function() {
        let _this = this;
        _this.lenNum += 20;
        this.getCountry(_this.area_name, _this.area_name, _this.area_con, _this.lenNum);
    },
    //获取所有区域国家
    'getAllArea': function() {
        const _this = this;
