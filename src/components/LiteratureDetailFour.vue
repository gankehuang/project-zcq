    ...
    <div class="container-main clearfix">
      ...
      <Card class="block-l content" id="block-l">
          ...
          <div class="layout-content">
            ...
            <div style="width:79%;display:inline-block;float:left;border:1px solid #EEEEEE;padding:10px; margin-top: 30px;">
              ...
              <p><span style="font-weight: bold;">点击下载PDF：</span><a :href="pdfImg" title="点击下载PDF"><img src="/static/img/pdf.png" style="height:20px;"/></a></p>
            ...
            <div style="width:20%;display:inline-block;float:right;height:400px;margin-left:10px; margin-top: 30px;">
                    <div style="width: 100%; border: 1px solid #E9EAEC; padding: 10px; overflow-x: auto;height:400px;">
            ...
            <div style="width:79%; display:inline-block; float:left; margin-top: 10px;">
            ...
            <div v-if="this.$route.params.status*1>58" style="float:left; display:inline-block;
             width: 79%">
