...
<div class="CountryDetail">
  ...
  <div class="Detail">
   <div class="block-l content" id="block-l" style="width: 100%;">
    ...
    <Card class="block-l content" style="width: 100%">
          <div style="color: gray; font-weight: bold;">免责声明：本平台所有地图、国家、地名等信息均来源于各类文献或政府机构报告的公开数据。本平台不对来源内容数据的可靠性、真实性承担任何责任，也不代表我们对海外任一国家，领土或海域的法律或宪法地位、边界划界表达任何意见。</div>
      </Card>
   </div>
     <!-- <div class="block-r">
       <div class="sidebar">
  ...
  mounted: function(){
    ...
    const prommise_getCountryDetail = _this.global.$post({
      ...
      'f_resolve': function(data){
        ...
        //国家概况图片处理
        //console.log('11111111111', data.CountryGkImages);
        if(data.CountryGkImages) {
        ...
        console.log('88888888', data.GeographyImage);
